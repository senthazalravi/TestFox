                ...
                case 'postmanResults':
                    try {
                        ...
                        if (!section || !summaryEl || !listEl) {
                            ...
                            container.id = 'postmanResultsSection';
                            container.className = 'section';
                            container.innerHTML = '<div class="section-title">Postman Run Results</div><div id="postmanSummary"></div><div id="postmanList"></div>';
                        ...
                        if (summaryEl) summaryEl.textContent = `Total: ${total}  Passed: ${passed}  Failed: ${failed}`;
                        if (listEl) {
                            listEl.innerHTML = '';
                            const executions = report?.results?.run?.executions || [];
                        ...
                        console.error('Failed to render postmanResults:', e);
                    }
                    break;
    }
});
