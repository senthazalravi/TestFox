...
export type TestCategory = 
    ...
    | 'payment'         // Payment and e-commerce flows
...
export const TEST_CATEGORIES: TestCategoryInfo[] = [
    ...
    { id: 'payment', name: 'Payment Tests', description: 'Payment flows, card validation, and fraud checks', group: 'functional', icon: 'credit-card', automationDefault: 'full' },
    ...
    { id: 'backend_compliance', name: 'Compliance Tests', description: 'GDPR and regulatory requirements', group: 'backend', icon: 'law', automationDefault: 'full' },
    { id: 'backend_observability', name: 'Observability Tests', description: 'Logging and monitoring safety', group: 'backend', icon: 'eye', automationDefault: 'full' }
];
...
export const CATEGORY_GROUPS = [
    ...
    { id: 'backend', name: 'Backend Testing', icon: 'server' }
];
